...
namespace ModernChess {
    ...
    public:
        ...
        inline bool squareIsAttackedByWhite(const BitBoard &board, Square square)
        {
            ...
            // attacked by king
            if ((knightAttackTable[square] & board.bitboards[Figure::WhiteKing]) != BoardState::empty)
            {
                return true;
            }
        ...
        inline bool squareIsAttackedByBlack(const BitBoard &board, Square square)
        {
            ...
            // attacked by king
            if ((knightAttackTable[square] & board.bitboards[Figure::BlackKing]) != BoardState::empty)
            {
                return true;
            }
