...
namespace
{
    ...
    TEST(BitBoardConstantsTest, NotABFile)
    {
        const BitBoardState board = BoardState::allSquaresOccupied & BitBoardConstants::notABFile;
        ...
        const std::vector<Square> notABFile {
                c1, d1, e1, f1, g1, h1,
                c2, d2, e2, f2, g2, h2,
                c3, d3, e3, f3, g3, h3,
                c4, d4, e4, f4, g4, h4,
    ...
    TEST(BitBoardConstantsTest, NotGHFile)
    {
        const BitBoardState board = BoardState::allSquaresOccupied & BitBoardConstants::notGHFile;
        ...
        const std::vector<Square> notGHFile {
                a1, b1, c1, d1, e1, f1,
                a2, b2, c2, d2, e2, f2,
                a3, b3, c3, d3, e3, f3,
                a4, b4, c4, d4, e4, f4,
