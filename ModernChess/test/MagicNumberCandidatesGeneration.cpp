...
class MagicNumberCandidatesGenerationTest : public testing::Test
    {
    public:
        // generate magic number candidate
        uint64_t generateMagicNumber()
        {
            return randomGenerator.getRandomU64Number() & randomGenerator.getRandomU64Number() & randomGenerator.getRandomU64Number();
        }
    ...
    TEST_F(MagicNumberCandidatesGenerationTest, getRandomU32Number)
    {
        EXPECT_EQ(randomGenerator.getRandomU32Number(), 1741896308);
        EXPECT_EQ(randomGenerator.getRandomU32Number(), 321584506);
        EXPECT_EQ(randomGenerator.getRandomU32Number(), 3694591032);
        EXPECT_EQ(randomGenerator.getRandomU32Number(), 1972257248);
        EXPECT_EQ(randomGenerator.getRandomU32Number(), 200407065);
    }

    TEST_F(MagicNumberCandidatesGenerationTest, generateMagicNumber)
    {
        EXPECT_EQ(generateMagicNumber(), 27162335321796624);
    }

    TEST_F(MagicNumberCandidatesGenerationTest, initMagicNumbers)
    {
        initMagicNumbers();
    }
}
